  ...
  <div className={styles['welcome-cta']}>
    ...
    <div className={styles['welcome-cta-featured']}>
      ...
      <div className={`row ${styles['welcome-cta-featured-container']}`}>
        <WelcomeFeature name="Fastsurfer" img={freesurferLogo} onClick={()=>{window.open('https://next.chrisstore.co/plugin/44')}} />
        <WelcomeFeature name="Infant-FreeSurfer" img={infantLogo} onClick={()=>{window.open('https://next.chrisstore.co/plugin/78')}}/>
        <WelcomeFeature name="IRTK reconstruction" img={biomediaLogo} onClick={()=>{window.open('https://next.chrisstore.co/plugin/85')}}/>
        <WelcomeFeature name="N4 Bias Field Correction" img={antLogo} onClick={()=>{window.open('https://next.chrisstore.co/plugin/77')}}/>
        <WelcomeFeature name="Civet" img={civetLogo} onClick={()=>{window.open('https://next.chrisstore.co/plugin/2')}}/>
      </div>
